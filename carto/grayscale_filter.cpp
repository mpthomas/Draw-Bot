...
int perlin_scale=25;
Mat imgmat1, imgmat2, imgmat3, imgmat4 ,canny;
Mat window_img[3], edges[3];

CartoImageProc *img;

CartoImageProc *procs[3] = {new CartoImageProc("/Users/matt/xcode/Cartogrifer/carto/carto/img.jpg"),
                           new CartoImageProc("/Users/matt/xcode/Cartogrifer/carto/carto/img.jpg"),
                           new CartoImageProc("/Users/matt/xcode/Cartogrifer/carto/carto/img.jpg")};
...
void init_window(int window_number) {
    ...
    *i=p->mat.clone();
    ...
    createTrackbar("Start",window_name,&starts[window_number],255,refresh_window,&window_number);
    createTrackbar("End",window_name,&ends[window_number],255,refresh_window,&window_number);
    createTrackbar("Perlin",window_name,&perlin_scales[window_number],100,refresh_window,(void *)(&window_number));
}

void refresh_window(int pos, void *userData) {
    int window_number = *((int *)userData);
